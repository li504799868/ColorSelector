...
import kotlinx.android.synthetic.main.activity_vertical_progress_color_selectir.*

class VerticalProgressColorSelectorActivity : AppCompatActivity() {

    private val hsv = FloatArray(3)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_vertical_progress_color_selectir)
